...
public class RequestHoarderDataPacket implements FabricPacket {
    public static final PacketType<RequestHoarderDataPacket> TYPE = PacketType.create(
        new net.minecraft.util.Identifier(XirosBorderBlock.MOD_ID, "request_hoarder_data"),
