...
public class ModItems {
    public static final Item BORDER_BUNDLE =
            registerItem("border_bundle", new BorderBundle(new FabricItemSettings()));

    public static void addItemsToIngredientTabItemGroup(FabricItemGroupEntries entries) {}

    public static Item registerItem(String name, Item item) {
        return Registry.register(
                Registries.ITEM, new Identifier(XirosBorderBlock.MOD_ID, name), item);
    }
