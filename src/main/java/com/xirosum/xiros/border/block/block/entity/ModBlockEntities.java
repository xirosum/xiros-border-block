...
public class ModBlockEntities {
    public static final BlockEntityType<BorderBlockEntity> BORDER_BLOCK_ENTITY =
            Registry.register(
                    ...
                    new Identifier(XirosBorderBlock.MOD_ID, "border_be"),
                    FabricBlockEntityTypeBuilder.create(
                                    BorderBlockEntity::new, ModBlocks.BORDER_BLOCK)
                            .build());

    public static final BlockEntityType<CorruptedBorderBlockEntity> CORRUPTED_BORDER_BLOCK_ENTITY =
            Registry.register(
                    Registries.BLOCK_ENTITY_TYPE,
                    new Identifier(XirosBorderBlock.MOD_ID, "corrupted_border_be"),
                    FabricBlockEntityTypeBuilder.create(
                                    CorruptedBorderBlockEntity::new,
                                    ModBlocks.CORRUPTED_BORDER_BLOCK)
                            .build());
