...
public class BorderBlock extends BaseBorderBlock implements BlockEntityProvider {
    private static final VoxelShape SHAPE = BorderBlock.createCuboidShape(0, 0, 0, 16, 16, 16);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(
        ...
        return checkType(
                type,
                ModBlockEntities.BORDER_BLOCK_ENTITY,
